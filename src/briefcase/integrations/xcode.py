...
class Xcode(Tool):
    ...
    def verify_install(
        ...
        **kwargs,
        ...
        :param min_version: The minimum allowed version of Xcode, specified as a tuple
            of integers (e.g., (11, 2, 1)). Default: ``None``, meaning there is no
            minimum version.
        """
    ...
    def ensure_xcode_is_installed(
        ...
        Raises an exception if Xcode isn't installed, or if the version of Xcode that is
...
def get_identities(tools: ToolCache, policy: str | None = None) -> dict[str, str]:
    ...
    :param tools: ToolCache of available tools
    :param policy: The identity policy to evaluate (e.g., ``codesigning``). If None, no
