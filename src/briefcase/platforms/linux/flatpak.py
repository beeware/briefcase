...
class LinuxFlatpakMixin(LinuxMixin):
    ...
    def flatpak_runtime(self, app):
        try:
            ...
            raise BriefcaseConfigError(r"""\ The App does not specify the Flatpak runtime
                                       to use.
    ...
    def flatpak_runtime_version(self, app):
        try:
            ...
            raise BriefcaseConfigError(
                r"""\ The App does not specify the version of the
                                       Flatpak runtime to use.
    ...
    def flatpak_sdk(self, app):
        try:
            ...
            raise BriefcaseConfigError(
                r"""\ The App does not specify the Flatpak SDK to
                                       use.
