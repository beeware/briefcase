...
from briefcase.integrations.virtual_environment import VirtualEnvironmentTool
...
class BaseCommand(ABC):
    ...
    def __init__(
        ...
        VirtualEnvironmentTool.verify(tools=self.tools)
...
"""
    ...
    def path_index(self, app: FinalizedAppConfig, path_name: str) -> str | dict | list:
    ...
    def template_target_version(self, app: FinalizedAppConfig) -> str | None:
    ...
    def stub_binary_revision(self, app: FinalizedAppConfig) -> str:
    ...
    def support_revision(self, app: FinalizedAppConfig) -> str:
    ...
    def app_requirements_path(self, app: FinalizedAppConfig) -> Path:
    ...
    def app_requirement_installer_args_path(self, app: FinalizedAppConfig) -> Path:
    ...
    def app_packages_path(self, app: FinalizedAppConfig) -> Path:
    ...
    def app_path(self, app: FinalizedAppConfig) -> Path:
    ...
    def app_module_path(self, app: FinalizedAppConfig) -> Path:
    ...
    def verify_app_template(self, app: FinalizedAppConfig):
