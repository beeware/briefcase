...
"""
    ...
    def bundle_package_path(self, app):
        ...
        This may be overridden if the user manually specifies a package path.
    ...
    def package_executable_path(self, app):
        ...
        :param app: The app config
        """
        if app.package_executable_path:
            return app.package_executable_path
        else:
        ...
        for app in apps:
            if hasattr(app, "__draft__"):
                ...
                if app.package_path:
                    ...
                    if app.package_executable_path:
                        raise BriefcaseConfigError(
                            f"{app.app_name!r} defines 'package_executable_path', but not 'package_path'."
                        )
