...
@pytest.fixture
def default_env() -> VirtualEnvironment:
...
def test_dev_xcode_app_starts(dev_command, first_app_config, tmp_path, default_env):
    """A macOS xcode app can be started in development mode."""
