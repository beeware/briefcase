...
def test_install_app_support_package(first_app_config, tmp_path):
    ...
    assert (support_path / 'lib').exists()
    assert (support_path / 'lib' / 'module.py').exists()
