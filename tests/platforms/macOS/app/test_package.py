...
def test_package_app_adhoc_sign(package_command, first_app_with_binaries, tmp_path):
    ...
    # A request has been made to sign the app
    package_command.sign_app.assert_called_once_with(app=first_app_with_binaries, identity='-')
...
def test_dmg_with_missing_installer_icon(package_command, first_app_with_binaries, tmp_path, capsys):
    ...
    assert "Can't find pretty.icns to use as DMG installer icon\n" in capsys.readouterr().out


def test_dmg_with_app_installer_icon(package_command, first_app_with_binaries, tmp_path):
...
def test_dmg_with_missing_app_installer_icon(package_command, first_app_with_binaries, tmp_path, capsys):
    ...
    # The warning about a missing icon was output
    assert "Can't find pretty_app.icns to use as fallback DMG installer icon\n" in capsys.readouterr().out


def test_dmg_with_installer_background(package_command, first_app_with_binaries, tmp_path):
...
def test_dmg_with_missing_installer_background(package_command, first_app_with_binaries, tmp_path, capsys):
    ...
    assert "Can't find pretty_background.png to use as DMG background\n" in capsys.readouterr().out
