...
from briefcase.platforms.linux import LinuxMixin, parse_freedesktop_os_release
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("opensuse/leap:15.4", "opensuse-leap", "15", None),
        ("opensuse/tumbleweed:latest", "opensuse-tumbleweed", "20230304", None),
