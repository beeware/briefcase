...
from briefcase.integrations.xcode import check_xcode_version
...
def test_installed_with_minimum_version_success(min_version, version, capsys):
    ...
    # Check passes without an error.
    check_xcode_version(min_version=min_version, sub=sub)
...
def test_unexpected_version_output(capsys):
    ...
    # Check passes without an error...
    check_xcode_version(min_version=(11, 2, 1), sub=sub)
