...
def test_single_iOS_runtime(mock_tools, simulator):
    ...
    assert simulators == {
        "iOS 13.2": {
            ...
            "314E772A-8034-44B4-9B28-3EE80C958F0A": (
...
def test_multiple_iOS_runtime(mock_tools, simulator):
    ...
    assert simulators == {
        ...
        "iOS 10.3": {
            ...
            "E582FF8E-A5DC-4985-B6C8-8D6B1795DF62": (
...
def test_alternate_format(mock_tools, simulator):
    ...
    assert simulators == {
        "iOS 12.0": {
            ...
            "AAF12280-0DC2-472F-87C5-2F141A6F0C55": (
                "iPad Pro (12.9-inch) (2nd generation)"
            ),
        ...
        "iOS 12.1": {
            ...
            "512E11C5-5654-4F10-98D7-F75C50DF5DB7": (
                "iPad Pro (12.9-inch) (3rd generation)"
            ),
            ...
            "F022D86A-E404-46C0-98B2-9AB63AD7008B": (
                "iPad Pro (12.9-inch) (2nd generation)"
            ),
