...
GPG_OUTPUT = "\n".join(
    [
        ...
        "uid:u::::1785485940::E70814C3C8DC3AC3940E8BFBA0288F0CE55F2120::Jane Doe <jane@example.com>::::::::::0:",  # noqa: E501
...
BOB_OUTPUT = "\n".join(
    [
        ...
        "uid:u::::1785485980::89A2D4C6E5F8B3E7::Bob Builder <bob@example.com>::::::::::0:",  # noqa: E501
    ]
)
BOB_OUTPUT += "\n"
