...
def test_download_sdk(mock_tools, host_os, tmp_path):
    ...
    if platform.system() == "Windows":
        mock_tools.os.access = MagicMock(spec_set=os.access)
    ...
    url = (
        ...
        f"commandlinetools-{sdk_download_tag(host_os)}-8092744_latest.zip"
    )
