...
def test_new_skin(mock_tools):
    ...
    mock_tools.download.file.assert_called_once_with(
        ...
        download_path=mock_tools.android_sdk.root_path,
    ...
    mock_tools.shutil.unpack_archive.assert_called_once_with(
        skin_tgz_path,
        extract_dir=mock_tools.android_sdk.root_path / "skins" / "pixel_X",
    )
...
def test_skin_download_failure(mock_tools, tmp_path):
...
def test_unpack_failure(mock_tools, tmp_path):
