...
def mock_tools(tmp_path, mock_tools) -> ToolCache:
    # Lock to macOS x86_64 so architecture-independent tests are deterministic.
    # Architecture filtering is tested separately in test_list_available_system_images_other_abi.
