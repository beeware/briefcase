...
def create_mock_appimage(appimage_path: Path, mock_appimage_kind: str = "original"):
    ...
    :param mock_appimage_kind: The kind of mock appimage to create.     'original'
        creates an unpatched mock appimage.     'patched' creates a patched mock
        appimage.     'corrupt' creates a corrupted mock appimage.
