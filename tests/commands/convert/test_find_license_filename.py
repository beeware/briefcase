...
def test_no_valid_license(tmp_path):
    ...
    create_file(license_file, "First App Changelog")
...
def test_multiple_changefile(tmp_path):
    ...
    license_file1 = tmp_path / "base_path/NEWS.txt"
    license_file2 = tmp_path / "base_path/CHANGELOG.md"
    create_file(license_file1, "First App Changelog")
    create_file(license_file2, "First App Changelog")
    assert find_license_filename(tmp_path / "base_path") == "CHANGELOG.md"
