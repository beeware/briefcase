...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "transmission. If we wish to make it louder, "
            "we will bring\nup the volume.\n",
            "There is nothing\n"
            "\n"
            "\n"
        ...
        (
            ...
            "a whisper. We will control the horizontal. We will control the "
            "vertical. "
            "We can roll the image, make it flutter. We can change the "
            "focus to a soft blur or sharpen it to crystal clarity. For the "
            "next "
            "hour, sit quietly, and we will control all that you see and "
            "hear. We repeat: There is nothing "
            "wrong with your television set.",
            "There is nothing wrong with your television set. Do not "
            "attempt to adjust the\n"
            "picture. We are controlling transmission. If we wish to make "
            "it louder, we\n"
            "will bring up the volume. If we wish to make it softer, we "
            "will tune it to a\n"
            "whisper. We will control the horizontal. We will control the "
            "vertical. We can\n"
            "roll the image, make it flutter. We can change the focus to a "
            "soft blur or\n"
            "sharpen it to crystal clarity. For the next hour, sit quietly, "
            "and we will\n"
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            80,
            "This is 83 characters long. This is 83 characters long. "
            "This is 83 characters long.",
            "This is 83 characters long. This is 83 characters long. "
