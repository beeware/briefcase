...
The value of ``package_path`` defines the path to the root of a folder that will be
packaged as an application. The contents of ``package_path`` is what will be shipped to
the end user as the installed app.
