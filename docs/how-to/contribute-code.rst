...
version number to the ``py-cov`` command. For example, ``py310-cov``.

Additionally, an HTML coverage report can be generated by using ``py-cov-html``
or ``py310-cov-html`` for a specific Python version.
